# Generated by Django 4.0 on 2022-05-20 06:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdBy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='corival.user')),
                ('participients', models.ManyToManyField(related_name='participient', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Questions',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='corival.user')),
            ],
        ),
        migrations.AddField(
